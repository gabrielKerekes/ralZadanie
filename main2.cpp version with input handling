...
int main()
{
	...
	while (!(cin >> p))
	{
		cin.clear();
		cin.ignore();
		cout << "Zadali ste zly vstup"<<endl;
		cout << "Zadajte P pre pole Fp: ";
	...
	while (!isPrime(p))
	{
		cout << "Zadali ste zle cislo. Zadane cislo musi byt prvocislo." << endl;
	...
	cout << "Kolko kongruencii chcete nacitat/vygenerovat (min 2, max 7):  ";
	
	while (!(cin >> numOfCongruences))
	{
		cin.clear();
		cin.ignore();
		cout << "Zadali ste zly vstup" << endl;
	...
	{
		cout << "Zadali ste zly pocet kongruencii." << endl;
	...
	cout << "Chcete zadat kongruencie alebo vygenorovat nahodne?" << endl;
	cout << "1. Zadat" << endl;
	cout << "2. Vygenerovat" << endl;
	cout << "Volba: ";
	...
	{
		cout << "Nespravna volba![bud 1 alebo 2]" << endl;
	...
	if (choice == 1)
	{
		cout << "POZOR!! Kongruencia musi byt v tvare napr. [1 2 3 4]"<<endl;
		...
		{
			cout << "Polynomi (m) musia byt medzi sebou nesudelitelne!" << endl;
